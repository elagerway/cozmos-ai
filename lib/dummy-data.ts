...
export const EXAMPLES: Example[] = [
  ...
  {
    id: "test-direct",
    prompt: "AI-generated: cozy mountain cabin at sunset (direct equirectangular)",
    status: "done",
    step: "done",
    step_label: "Your sphere is ready",
    sphere_spec: null,
    bg_prompt: null,
    image_url: "/spheres/test-direct.jpg",
    error: null,
    cost_usd: 0.01,
    duration_s: 15,
  ...
  {
    id: "test-cubemap",
    prompt: "AI-generated: cozy mountain cabin at sunset (cubemap → equirectangular)",
    status: "done",
    step: "done",
    step_label: "Your sphere is ready",
    sphere_spec: null,
    bg_prompt: null,
    image_url: "/spheres/test-cubemap.jpg",
    error: null,
    cost_usd: 0.05,
    duration_s: 45,
